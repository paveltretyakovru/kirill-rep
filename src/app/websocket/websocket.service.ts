...
import { IWebsocketService, WsMessage, WebSocketConfig } from './websocket.interfaces';
...
export class WebsocketService implements IWebsocketService, OnDestroy {
    ...
    protected config: WebSocketSubjectConfig<WsMessage<any>>;
